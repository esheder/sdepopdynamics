...
from biopop_closure.matispop import badgers_params, badgers_params_multiple_births, badgers_multiplicity_vector, \
    foxes_multiplicity_vector, _foxes_params_multiple_births_paper, foxes_params_multiple_births
